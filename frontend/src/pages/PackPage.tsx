...
type Bag = { id: number; bag_index: number; weight_kg: number; volume_l: number; open_reason: string | null; items: { stop_name: string }[] };
  ...
  return (<>
    ...
    {bags.map(b => (
      <div key={b.id}>
        ...
        {b.open_reason && <div className="bag-reason">开袋原因：{b.open_reason}</div>}
